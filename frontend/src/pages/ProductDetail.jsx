...
export default function ProductDetail() {
  ...
  const guideMin = Number(
    priceGuide?.guideMin ?? priceGuide?.minPrice ?? item.guideMin,
  );

  const guideMax = Number(
    priceGuide?.guideMax ?? priceGuide?.maxPrice ?? item.guideMax,
  );
        ...
        <div style={styles.guideBox}>
          ...
          <div style={styles.guideTextRow}>
            <div style={styles.guideMainText}>
              이 가격은{" "}
              <span style={{ color: guideInfo.color }}>{guideInfo.label}</span>{" "}
              안에 있어요
            </div>
          ...
          >
            ...
            {item.sellerAnalysis ? (
              <>
                ...
                <div style={styles.sheetSection}>
                  <div style={styles.sheetSectionTitleBlue}>
                    커뮤니케이션 스타일
                  </div>
                  <TraitBar
                    label="응답 패턴"
